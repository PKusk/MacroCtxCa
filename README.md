...
4. Align images and mask to  bregma and lambda.
...
7. Annotate spatial components to the ACCF map.
   -  Run the next section. This section annotates each component based on the highest mean value for a given region.
     
8. Score each temporal component based on a generated "score-trace".
   - dgf
